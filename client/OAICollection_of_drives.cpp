...
class OAICollection_of_drivesPrivate {
    friend class OAICollection_of_drives;
...
OAICollection_of_drives::OAICollection_of_drives(const OAICollection_of_drives& other)
    : d_ptr(other.d_ptr)
{
}
...
OAICollection_of_drives::~OAICollection_of_drives() = default;

void OAICollection_of_drives::initializeModel() {
    if (d_ptr == nullptr) {
        d_ptr.reset(new OAICollection_of_drivesPrivate{});

        Q_D(OAICollection_of_drives);
