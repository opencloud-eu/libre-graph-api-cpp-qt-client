...
signals:
    ...
    void listApplicationsSignal(OAICollection_of_applications summary);

    void getApplicationSignalFull(OAIHttpRequestWorker *worker, OAIApplication summary);
    void listApplicationsSignalFull(OAIHttpRequestWorker *worker, OAICollection_of_applications summary);

    void getApplicationSignalE(OAIApplication summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listApplicationsSignalE(OAICollection_of_applications summary, QNetworkReply::NetworkError error_type, QString error_str);
