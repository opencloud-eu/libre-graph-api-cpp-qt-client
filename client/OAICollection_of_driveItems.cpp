...
class OAICollection_of_driveItemsPrivate {
    friend class OAICollection_of_driveItems;
...
OAICollection_of_driveItems::OAICollection_of_driveItems(const OAICollection_of_driveItems& other)
    : d_ptr(other.d_ptr)
{
}
...
OAICollection_of_driveItems::~OAICollection_of_driveItems() = default;

void OAICollection_of_driveItems::initializeModel() {
    if (d_ptr == nullptr) {
        d_ptr.reset(new OAICollection_of_driveItemsPrivate{});

        Q_D(OAICollection_of_driveItems);
...
QJsonObject OAICollection_of_driveItems::asJsonObject() const {
    Q_D(const OAICollection_of_driveItems);
    if(!d){
        return {};
    }
    QJsonObject obj;
